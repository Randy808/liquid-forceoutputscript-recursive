...
let makerKeypair = ECPair.fromPrivateKey(makerPrivateKey);
let takerKeypair = ECPair.fromPrivateKey(takerPrivateKey);
...
export { makerKeypair, takerKeypair, internalKeypair, getRandomKeypair };
